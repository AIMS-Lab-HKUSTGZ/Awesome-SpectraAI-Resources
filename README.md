...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | --------------- | ----------------------- | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| [Towards a Unified Benchmark and Framework for Deep Learning-Based Prediction of NMR Chemical Shifts](https://arxiv.org/abs/2306.13549) | Foundation pretrain + finetune | arXiv 2023      | 3D molecular structures | MAE (ppm)    | [NMRNet](https://github.com/Colin-Jay/NMRNet) · [Zenodo](https://zenodo.org/records/13317524)                                                   | Masked pretraining on 3D; unified benchmark framing |
